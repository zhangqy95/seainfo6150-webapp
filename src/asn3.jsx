...
<ul>
      <div><li> Total overall height from the base of the pedestal foundation to the tip of the torch is <b>305 feet, 6 inches</li></b></div>

    <div> <li>  Height of the Statue from her heel to the top of her head is 111 feet, 6 inches</li></div>

    <div><li> The Statue has a <b>35-foot</b> waistline</li></div>

    <div><li> Total weight of the Statue of Liberty is <b>225 tons (or 450,000 pounds)</li></b></div>
</ul>
    </body>
    </div>
  )
